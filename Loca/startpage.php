// "en"
    $LocaLang = "en";
    {
        ...
        loca_add("TIP_203" , "");
        loca_add("TIP_204" , "T&C:<br /> Accept the T&C (Terms and Conditions) to be able to play the Game.");
        ...
        loca_add("MENU_ABOUT",       "About The Game");
        ...
        loca_add("ABOUT_TEXT8",  "Whatever you wish to do, <strong>TheGame can let you do it.</strong>");
